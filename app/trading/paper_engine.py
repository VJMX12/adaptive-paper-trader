...
There is no code path anywhere in this project that submits an order:
the ccxt client is constructed without credentials and only public
read endpoints are called.
"""
